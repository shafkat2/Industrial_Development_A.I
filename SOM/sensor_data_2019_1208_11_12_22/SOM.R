...
#library(readxl)
#library(tseries)
my_data <- read.csv("sensor_data_2019_1208_11_12_22.csv")
...
data_train <- my_data[, c(1,2,3,4,5,6)]
...
som_grid <- somgrid(xdim = 49, ydim=49, topo="hexagonal")
...
plot(som_model, type = "property", property = som_model$codes[[1]], main=names(som_model$data)[1:2406,1:6], palette.name=coolBlueHotRed)
