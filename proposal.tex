...
\item(2){ after cutting 2 bperson take the  materials from scrapyard to the furnace the material is transferred to the furnace using a crane operated by one person } 
...
\item(5){ 3 person is applied to casting}
\item(6){ 1 person operates the machine 2 person checks the blister packing}
\item(7){ 3 person checks the carton packings}
