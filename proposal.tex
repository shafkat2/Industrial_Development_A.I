...
\item(1){ 1 person controls this step for proper cutting of raw materials}
...
\item(3){ 2-3 person monitor and control the furnace }
...
\item{ transition between some of the process are done through crane which is operated by a person}
